...
class Perf_failed_test(BaseTest):
    ...
    # 1. -> 1.1. **** 1.1. -> 1.1.2. **** 1.1.2. -> 1.1.2.4. **** 1.1.2.4. -> 1.1.2.4.2. **** 1.1.2.4.2. -> 1.1.2.4.__1 **** 1.1.2.4. -> 1.1.2.4.2. **** 1.1.2.4.2. -> 1.1.2.4.__1 **** 1.1.2.4. -> 1.1.2.4.1. **** 1.1.2.4.1. -> 1.1.2.4.__1 **** 1.1.2.4. -> 1.1.2.4. **** 1.1.2.4. -> 1.1.2.4. **** 1.1.2.4. -> 1.1.2.4. **** 1.1.2.4. -> 1.1.2.4.2. **** 
